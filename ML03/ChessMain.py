...
promote_sound = p.mixer.Sound(r'E:\Pycharm\pythonProject\promote.mp3')
castle_sound = p.mixer.Sound(r'E:\Pycharm\pythonProject\castle.mp3')
check_sound = p.mixer.Sound(r'E:\Pycharm\pythonProject\move-check.mp3')
capture_sound = p.mixer.Sound(r'E:\Pycharm\pythonProject\capture.mp3')
move_sound = p.mixer.Sound(r'E:\Pycharm\pythonProject\move-self.mp3')
notify_sound = p.mixer.Sound(r'E:\Pycharm\pythonProject\notify.mp3')
